...
// Jackson JsonNode for flexible JSON fields
...
public class PersonDossier {
    ...
    // current_address TEXT -- stored as JSON string in DB, mapped to JsonNode in entity
    private String currentAddress;
    @Column(name = "permanent_address", columnDefinition = "TEXT")
    private String permanentAddress;

    // permanent_address TEXT -- stored as JSON string in DB, mapped to JsonNode in entity
